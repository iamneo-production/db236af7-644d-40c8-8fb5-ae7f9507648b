...
(async () => {
    ...
    try{
    await page.goto('https://8081-dadecaeedcbbfdebbecaddaeffdec.project.examly.io/');
...
(async () => {
    ...
    const page = await browser.newPage();
    try{
    await page.goto('https://8081-ddaaedffdcbbfdebbecaddbaaecadafbad.project.examly.io/');
    await page.setViewport({
      width:1200,
      height:800,
    })
...
(async () => {
  ...
  const page = await browser.newPage();
  try{
  await page.goto('https://8081-ddaaedffdcbbecaddbaaecadafbad.project.examly.io/');
  await page.setViewport({
    width:1200,
    height:800,
  })
