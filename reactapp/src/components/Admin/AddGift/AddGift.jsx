...
{giftFromDb.map((items,index)=>
{
  return<div className='col-xxl-3 col-md-4 col-sm-4 gy-3 ' key={index}>
        <div className="card h-100 border-0 text-center" >          
           ...
           <img className="h-50 w-50 p-2 cardimage " src={items.giftImageUrl} alt="Card image cap"/>
                <h5 className="card-title">{items.giftName}</h5>
                 <p className="card-text">  💲{items.giftPrice}</p>
                 <p className="card-text ">  {items.giftQuantity} <span>ps</span> </p>
     ...
     <div className=' d-flex justify-content-center align-items-center position-absolute top-50 start-50 translate-middle' >
      ...
      <h4 className='text-center'>Adding..!</h4>
        ...
        <div className='form-group '>
          ...
          <input className='form-control ' placeholder='gift name' id='enterGiftName' name='giftName' onChange={handlegiftDetails}></input>
        </div>
        <div className='form-group '>
